---
title: "Алгоритм проверки сайта на соответствие 152-ФЗ"
date: 2026-05-23
summary: "Подробный чек-лист аудита сайта по 152‑ФЗ: карта обработки, согласия, cookies, передача третьим лицам, локализация и финальный отчет."
---
...
Проверка уведомления РКН не выносится отдельным этапом. Она фиксируется здесь, в карте обработки. У Роскомнадзора есть реестр операторов, где сведения об операторах являются общедоступными, а поиск можно делать, в частности, по ИНН организации. ([Портал персональных данных][2])
...
У Роскомнадзора есть электронная форма уведомления, где указываются сведения об операторе, включая тип оператора и наименование; это подтверждает, что уведомление — обязанность оператора, а не отдельный элемент интерфейса сайта. ([Портал персональных данных][3])
